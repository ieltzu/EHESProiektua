...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		Atal honetako .jar exekutagarria {\red Preprocess.jar} fatxategia da, eta programa ondo funtziona dezan, lau parametro behar ditu gutxienez:
		\begin{enumerate}
			\item Development {\bf .arff} fitxategia. Kasu honetan, {\blue dev.p3.obfuscated.arff} fitxategia.
			\item Aurreko fitxategia arreprozezatu hondoren, arff fitxategi berria sortu nahi den helbidea. Adibidez {\blue devaurre.arff} fitxategia sortzen genuen, baina edozein izen har dezake.
			\item Entrenamendu {\bf .arff} fitxategia. Kasu honetan, {\blue train.p3.resampled.obfuscated.arff} fitxategia.
			\item Hirugarren parametroan adierazi den fitxategia arreprozezatu hondoren, arff fitxategi berria sortu nahi den helbidea. Adibidez {\blue trainaurre.arff} fitxategia sortzen genuen, baina edozein izen har dezake.
