...
public class Idazlea {
	...
	public void fitxategiaEginOneR(String path, Evaluation evaluator, OneR one, Double bucketSizeExhaustiboa){
		 try {
			...
			try {
				...
				fw.append("BucketSize Maximoa: " + evaluator+"\n");
	...
	public void fitxategiaEginMultilayerPerceptron(String path, Evaluation evaluator, MultilayerPerceptron estimador, String hidenLayerEzExhaustiboa){
